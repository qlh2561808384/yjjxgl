...
<script type="text/javascript">
    ...
    function search(){
 	  ...
 	  var authId = "<%=ConfigureParser.getPropert("authId","UTF-8")%>";
	    ...
	    for(var i=0;i<dataArr.length;i++){
    		...
    		+ "&authId=" + authId + "&variants=YHM="+dataArr[i].USERID+";XZQH=;GKCS=;DW=;SJ="+dataArr[i].SJ+"";
   ...
   function searchSummery(){
    	...
    	var bburl=url+"hrServlet?fileName="
			...
			+ "&authId=" + authId + "&variants=YHM=;XZQH=;GKCS=;DW=;SJ="+dataArr[0].SJ;
   ...
   function exportReport(){
 	  ...
 	  var authId = "<%=ConfigureParser.getPropert("authId","UTF-8")%>";
	    ...
	    for(var i=0;i<dataArr.length;i++){
    		...
    		+fillname+ "&targetVolume=" + targetVolumn
    		+ "&authId=" + authId + "&variants=reportWriteable=false;YHM="+dataArr[i].USERID+";XZQH=;GKCS=;DW=";
    		indata+=","+dataArr[i].USERID+"|"+dataArr[i].ENTENAME+"|"+dataArr[i].SJ;
	    }
