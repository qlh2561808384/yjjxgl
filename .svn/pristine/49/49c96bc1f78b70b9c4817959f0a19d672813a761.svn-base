	...
	view = {
		...
		makeDOMNodeIcon: function(html, setting, node) {
			...
			html.push("<span id='", node.tId, consts.id.ICON,
				...
				"'>",name,"</span><span id='", node.tId, consts.id.BADGE,"' class='badge badge-primary' style='", view.makeNodeBadgeStyle(setting, node) ,"'></span>");
		},
		...
		makeNodeBadgeStyle: function(setting, node) {
			var badgeStyle = [];
			if (!node.isAjaxing) {
				if (setting.view.showBadge == false || !tools.apply(setting.view.showBadge, [setting.treeId, node], true)) {
					badgeStyle.push("display:none;");
				}
			}
			return badgeStyle.join('');
		},
