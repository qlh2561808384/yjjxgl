...
<head>
    ...
    <script type="text/javascript">
        ...
        var enReport = "<%= ConfigureParser.getPropert("JXZPID")%>";
        ...
        $(function() {
            $("#datatable").dtable({
                ...
                url : 'pro/getBasePerformance.do',//请求地址
                searchbar: {
                    ...
                    inputs: [//搜索栏表单参数
                        {
                            ...
                            id:'nodenum',
                            checkType:'radio',
                            url : 'pro/getPerformanceStepcodeTree.do?userKey='+userKey,
                            onAckCallback:function(nodes){
                                if(nodes.length>0){
        ...
        function editReport() {
            ...
            if (dataArr.length != 1) {
                ...
                if(dataArr[0].ISOPEN == 0 && time < dataArr[0].DEADLINEDATE){
                    ...
                    var edit_filename = "<%=ConfigureParser.getPropert("JXZPID")%>";
                    var read_filename = "<%=ConfigureParser.getPropert("READ_JXZPID")%>";
        ...
        function submitBaseInfo() {
            ...
            if (dataArr.length == 0) {
                ...
                if(dataArr[0].ISOPEN == 0 && time < dataArr[0].DEADLINEDATE){
                    if(dataArr[0].STEPCODE == 1){
                        if(null == dataArr[0].XMSSQK || null == dataArr[0].XMJXQK || null == dataArr[0].QTSMWT){
                            $.dalert({
                                text:"填写完整报表之后才能提交哦！",
                                icon:7
                            });
                            ...
                            $.dajax({
                                cache: true,
                                type: "POST",
                                url: "pro/submitBasePerformance.do",
                                /*data : {
                                 "year" : dataArr[0].YEAR,
                                 "eid" : dataArr[0].EID,
                                 "iid" : dataArr[0].IID,
        ...
        function backBaseInfo() {
            ...
            if (dataArr.length == 0) {
                ...
                $.dajax({
                    cache : true,
                    type : "POST",
                    url : "pro/backBasePerformance.do",
                    /*data : {
                     "year" : dataArr[0].YEAR,
                     "eid" : dataArr[0].EID,
                     "iid" : dataArr[0].IID,
